...
export default function AdminProductsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4">
        <Link href="/admin/products/create" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
          Ajouter un Produit
        </Link>
      </div>
      {isLoading ? (
                ...
                <tr key={product.id}>
                  ...
                  <td className="py-2 px-4 border">
                    <div className="flex gap-2">
                      <Link href={`/admin/products/edit/${product.id}`} className="text-blue-500 hover:underline">
                        Modifier
                      </Link>
                      <button
